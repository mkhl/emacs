...
Configure key bindings for =vimpulse=.
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun init/setup-vimpulse-mode-maps ()
    (define-key viper-insert-basic-map "\C-d" nil)
    (define-key viper-insert-basic-map "\C-t" nil)
    (define-key viper-insert-basic-map "\C-p" nil)
    (define-key viper-insert-basic-map "\C-n" nil)
    (define-key viper-vi-basic-map "K" 'man)
    (define-key viper-vi-basic-map "\C-o" nil)
    (define-key viper-vi-basic-map "\C-i" nil))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (when viper-mode
    (require 'rect)                       ; Missing `vimpulse' dependency
    (require 'vimpulse nil 'noerror))
  
  (eval-after-load 'vimpulse
    '(init/setup-vimpulse-mode-maps))
#+END_SRC
